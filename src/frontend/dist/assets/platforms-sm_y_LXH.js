...
const AddAccountRequest = Record({
  "refreshToken": Text,
  "platform": Platform,
  "accessToken": Text,
  "accountHandle": Text
...
const AccountId = Nat;
const Timestamp = Int;
const SocialAccountPublic = Record({
  "id": AccountId,
  "createdAt": Timestamp,
  "platform": Platform,
  "isActive": Bool,
...
const CreatePostRequest = Record({
  ...
  "mediaBlob": ExternalBlob$1,
  "selectedPlatforms": Vec(Platform)
});
const PostId = Nat;
...
const PostPublic = Record({
  ...
  "updatedAt": Timestamp,
  "mediaBlob": ExternalBlob$1,
  "platformResults": Vec(PlatformResult),
  "selectedPlatforms": Vec(Platform)
});
const PlatformCaption = Record({
  "hashtags": Vec(Text),
  "platform": Platform,
  "caption": Text
});
const OptimizationResult = Record({
  "suggestions": Vec(PlatformCaption),
...
Service({
  ...
  "addSocialAccount": Func([AddAccountRequest], [SocialAccountPublic], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "createPost": Func([CreatePostRequest], [PostPublic], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getOptimizationResult": Func(
    [PostId],
    [Opt(OptimizationResult)],
    ["query"]
  ),
  "getPost": Func([PostId], [Opt(PostPublic)], ["query"]),
  "getPublishResults": Func(
    [PostId],
    [Vec(PlatformResult)],
    ["query"]
  ),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listPosts": Func([], [Vec(PostPublic)], ["query"]),
  "listSocialAccounts": Func(
    [],
    [Vec(SocialAccountPublic)],
    ["query"]
  ),
  "optimizeCaption": Func([PostId], [OptimizationResult], []),
  "publishPost": Func([PostId], [Vec(PlatformResult)], []),
  "revokeSocialAccount": Func([AccountId], [Bool], []),
  "transformAi": Func(
    [TransformationInput],
    [TransformationOutput],
    ["query"]
  ),
  "transformPublish": Func(
    [TransformationInput],
    [TransformationOutput],
    ["query"]
  )
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const AddAccountRequest2 = IDL2.Record({
    "refreshToken": IDL2.Text,
    "platform": Platform2,
    "accessToken": IDL2.Text,
    "accountHandle": IDL2.Text
  });
  const AccountId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const SocialAccountPublic2 = IDL2.Record({
    "id": AccountId2,
  ...
  const CreatePostRequest2 = IDL2.Record({
    "mediaFilename": IDL2.Text,
    "originalCaption": IDL2.Text,
    "mediaBlob": ExternalBlob2,
    "selectedPlatforms": IDL2.Vec(Platform2)
  });
  ...
  const PlatformResult2 = IDL2.Record({
    "status": PublishStatus2,
    "postUrl": IDL2.Opt(IDL2.Text),
    "publishedAt": IDL2.Opt(Timestamp2),
    "platform": Platform2
  });
  const PostPublic2 = IDL2.Record({
    "id": PostId2,
    "mediaFilename": IDL2.Text,
    "createdAt": Timestamp2,
    "originalCaption": IDL2.Text,
    ...
    "mediaBlob": ExternalBlob2,
    "platformResults": IDL2.Vec(PlatformResult2),
    "selectedPlatforms": IDL2.Vec(Platform2)
  });
  const PlatformCaption2 = IDL2.Record({
    "hashtags": IDL2.Vec(IDL2.Text),
    "platform": Platform2,
    "caption": IDL2.Text
  });
  const OptimizationResult2 = IDL2.Record({
    "suggestions": IDL2.Vec(PlatformCaption2),
  ...
  return IDL2.Service({
    ...
    "addSocialAccount": IDL2.Func(
      [AddAccountRequest2],
      [SocialAccountPublic2],
      []
    ),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "createPost": IDL2.Func([CreatePostRequest2], [PostPublic2], []),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getOptimizationResult": IDL2.Func(
      [PostId2],
      [IDL2.Opt(OptimizationResult2)],
      ["query"]
    ),
    "getPost": IDL2.Func([PostId2], [IDL2.Opt(PostPublic2)], ["query"]),
    "getPublishResults": IDL2.Func(
      [PostId2],
      [IDL2.Vec(PlatformResult2)],
      ["query"]
    ),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listPosts": IDL2.Func([], [IDL2.Vec(PostPublic2)], ["query"]),
    "listSocialAccounts": IDL2.Func(
      [],
      [IDL2.Vec(SocialAccountPublic2)],
      ["query"]
    ),
    "optimizeCaption": IDL2.Func([PostId2], [OptimizationResult2], []),
    "publishPost": IDL2.Func([PostId2], [IDL2.Vec(PlatformResult2)], []),
    "revokeSocialAccount": IDL2.Func([AccountId2], [IDL2.Bool], []),
    "transformAi": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    ),
    "transformPublish": IDL2.Func(
      [TransformationInput2],
      [TransformationOutput2],
      ["query"]
    )
...
class Backend {
  ...
  async getOptimizationResult(arg0) {
    if (this.processError) {
      try {
  ...
  async revokeSocialAccount(arg0) {
    if (this.processError) {
      try {
...
async function from_candid_ExternalBlob_n26(_uploadFile, _downloadFile, value) {
  return await _downloadFile(value);
}
function from_candid_OptimizationResult_n36(_uploadFile, _downloadFile, value) {
  return from_candid_record_n37(_uploadFile, _downloadFile, value);
}
function from_candid_PlatformCaption_n39(_uploadFile, _downloadFile, value) {
  return from_candid_record_n40(_uploadFile, _downloadFile, value);
}
function from_candid_PlatformResult_n28(_uploadFile, _downloadFile, value) {
  return from_candid_record_n29(_uploadFile, _downloadFile, value);
}
function from_candid_Platform_n14(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n15(_uploadFile, _downloadFile, value);
}
async function from_candid_PostPublic_n22(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n23(_uploadFile, _downloadFile, value);
}
function from_candid_PublishStatus_n24(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n25(_uploadFile, _downloadFile, value);
}
function from_candid_SocialAccountPublic_n12(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n15(_uploadFile, _downloadFile, value) {
  return "linkedin" in value ? "linkedin" : "tiktok" in value ? "tiktok" : "twitter" in value ? "twitter" : "instagram" in value ? "instagram" : "facebook" in value ? "facebook" : value;
}
...
function to_candid_AddAccountRequest_n8(_uploadFile, _downloadFile, value) {
  return to_candid_record_n9(_uploadFile, _downloadFile, value);
}
async function to_candid_CreatePostRequest_n18(_uploadFile, _downloadFile, value) {
...
function to_candid_Platform_n10(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n16(_uploadFile, _downloadFile, value) {
...
async function to_candid_record_n19(_uploadFile, _downloadFile, value) {
  return {
    mediaFilename: value.mediaFilename,
    originalCaption: value.originalCaption,
...
function to_candid_vec_n21(_uploadFile, _downloadFile, value) {
